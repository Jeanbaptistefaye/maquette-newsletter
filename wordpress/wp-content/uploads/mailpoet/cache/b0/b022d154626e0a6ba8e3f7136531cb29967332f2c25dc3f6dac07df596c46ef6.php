...
class __TwigTemplate_5843902bcfdf86efdb4136559c238976020557ce778c7e8526d39ca7cc9ca10a extends Twig_Template
{
      ...
      <td>
        ...
        echo "        >
          <a
            ...
            href=\"";
        // line 55
        echo twig_escape_filter($this->env, ((array_key_exists("premium_install_url", $context)) ? (_twig_default_filter(($context["premium_install_url"] ?? null), "#")) : ("#")), "html", null, true);
        echo "\"
          >";
        // line 56
        ...
        echo "</span>
          <a
            ...
            href=\"";
        // line 74
        echo twig_escape_filter($this->env, ((array_key_exists("premium_activate_url", $context)) ? (_twig_default_filter(($context["premium_activate_url"] ?? null), "#")) : ("#")), "html", null, true);
        echo "\"
          >";
        // line 75
...
";
    ...
    {
        return new Twig_Source("", "settings/premium.html", "/var/www/html/maquette/wordpress/wp-content/plugins/mailpoet/views/settings/premium.html");
    }
}
